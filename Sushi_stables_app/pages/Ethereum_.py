...
from Sushiswap_Stablecoins_app import querying_pagination, config
...
ethereum_logo_path = "sushi_stables_app/ethereum-eth-logo.png"
ethereum_logo_base64 = get_image_base64(ethereum_logo_path)
html_string = html_string = f'<h1 style="font-size: 2em; display: inline;"><img src="data:image/png;base64,{ethereum_logo_base64}" width="30" height="30" style="vertical-align: middle; padding-bottom: 5px;"/> Ethereum Stablecoin Volume</h1>'
